...
def test_settings():
    ...
    cs.settings.set_figure_params(format='png',figsize=[4,3.5],dpi=25,fontsize=14,pointsize=3,dpi_save=25)
...
def test_Tmap_inference():
    ...
    adata=cs.tmap.infer_Tmap_from_multitime_clones(adata_orig,clonal_time_points=['2','4'], 
                        later_time_point='6',smooth_array=[5,5,5],
              sparsity_threshold=0.1,intraclone_threshold=0.2,max_iter_N=5,epsilon_converge=0.01)
    ...
    adata_1=cs.tmap.infer_Tmap_from_one_time_clones(adata_orig,initial_time_points=['4'],
            later_time_point='6',initialize_method='OT',OT_cost='GED',
                    smooth_array=[5,5,5],sparsity_threshold=0.1)
    ...
    adata_2=cs.tmap.infer_Tmap_from_state_info_alone(adata_orig,initial_time_points=['4'],
        ...
        epsilon_converge=[0.01,0.01],smooth_array=[5,5,5],sparsity_threshold=0.1)
...
def test_Tmap_plotting():
    ...
    cs.pl.dynamic_trajectory_via_iterative_mapping(adata,
